...
% to compile: xelatex cfa.tex

% TO DO
% - insert hard facts dummies
% - correct sizing for images in annex
% - adjust title size, margins remove date
...
% font specs, only works with xelatex
\usepackage{fontspec}
...
\usepackage{tabularx}
% manipulate captions, specifically remove numbering via \caption*{} 
\usepackage{caption}
